...
set_property -dict { PACKAGE_PIN T6    IOSTANDARD LVCMOS33 } [get_ports { rs232_user_rxd }]; #IO_L17N_T2_34 Sch=jc_n[3]
set_property -dict { PACKAGE_PIN AB7   IOSTANDARD LVCMOS33 } [get_ports { rs232_user_txd }]; #IO_L20P_T3_34 Sch=jc_p[4]
